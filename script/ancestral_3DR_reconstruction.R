...
# Parameters
mode="" # "" "_deepbind" "_cons"
spec="vertebrates" # "mammals" or "vertebrates" 
...
stat=matchTreeMat$X3DR
names(stat)=tree$tip.label
ancML=anc.ML(tree,x=stat)

# Plot ancestral character reconstruction
dir.create("results/phylo/")
file_plottree_3DR=paste0("results/phylo/ancestral_3DR_reconstruction_",spec,mode,".pdf")
pdf(file_plottree_3DR,10,12)
